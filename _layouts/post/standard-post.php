...
<main class="outer-container">
	<article itemscope itemtype="http://schema.org/BlogPosting">
		...
		<section itemprop="articleBody" id="article-body">
			...
			{{ content }}
			<h4 id="contact-c2a">If you are interested in having an original website created, <a href="http://studioncreations.com/contact" class="underlined" target="_blank">contact the <span class="inline">Studio N Creations</span> team</a> and get started today.</h4>
		</section>
